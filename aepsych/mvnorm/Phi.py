...
def phi2_sub(
    z, C
):  # compute pairs of bivariate densities and organize them in a matrix
...
class PhiHighDim(Function):
    ...
    def forward(ctx, m, c):
        m_np = m.numpy()
        c_np = 0.5 * (c + c.transpose(-1, -2)).numpy()
...
if __name__ == "__main__":
    ...
    def jacobian(y, x, create_graph=False):
        ...
        flat_y = (y * 1).reshape(
            -1
        )  # does someone know why it doesn't work without this one?
